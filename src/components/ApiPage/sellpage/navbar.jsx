...
<div className="navbar mx-auto rounded-xl bg-slate-900 w-3/4 flex h-16 justify-between p-4">
 ...
 <Link className=''><button className=" bg-slate-400 rounded-lg md:w-20 text-slate-800 text-[17px] md:h-10  hover:bg-red-500" onClick={signout}>Sign out</button></Link>
